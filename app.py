...
# CSS for fixed floating progress tracker on desktop, normal on mobile
st.markdown("""
    <style>
    /* Fixed position progress tracker on desktop */
    .fixed-progress {
        position: fixed;
        top: 90px;
        left: 10px;
    ...
    /* On small/mobile screens, disable fixed position and full width */
